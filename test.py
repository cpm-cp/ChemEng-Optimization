...
class PipeOptimizationApp:
    ...
    def __init__(self, page: ft.Page):
        """UI class for the pipile line system."""
        self.page = page
        self.setup_page()
    ...
    def create_ui_components(self):
        ...
        self.header = ft.Container(
            content=ft.Row([
                ft.Icon(ft.icons.AC_UNIT_OUTLINED, size=20, color="#2B47B9"),
                ft.Text("Pipeline System", size=22, weight=ft.FontWeight.BOLD, color="#2B47B9"),
